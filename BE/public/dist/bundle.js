...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/components/App.scss":
/*!***********************************************************************************************************!*\
  !*** ./node_modules/css-loader!./node_modules/sass-loader/lib/loader.js!./src/styles/components/App.scss ***!
  \***********************************************************************************************************/
...
var addNewResource = exports.addNewResource = function addNewResource(inputValue) {
	return { type: 'ADD_NEW_RESOURCE', inputValue: inputValue };
};

var updateValue = exports.updateValue = function updateValue(inputValue, name) {
...
__webpack_require__(/*! ../styles/components/App.scss */ "./src/styles/components/App.scss");

var _FormContainer = __webpack_require__(/*! ../containers/FormContainer */ "./src/containers/FormContainer.js");

var _FormContainer2 = _interopRequireDefault(_FormContainer);

var _ResourcesContainer = __webpack_require__(/*! ../containers/ResourcesContainer */ "./src/containers/ResourcesContainer.js");

var _ResourcesContainer2 = _interopRequireDefault(_ResourcesContainer);
...
var App = function App() {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(_ResourcesContainer2.default, null)
  );
};
...
var _FormInput = __webpack_require__(/*! ./FormInput */ "./src/components/FormInput.js");
...
var Form = function Form(_ref) {
	var updateValue = _ref.updateValue,
	    ...
	    addNewResource = _ref.addNewResource;
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(_FormInput2.default, { name: 'url',
			updateValue: updateValue,
			inputValue: inputValue.url,
			error: inputValue.urlError }),
		_react2.default.createElement(_FormInput2.default, { name: 'title',
			updateValue: updateValue,
			inputValue: inputValue.title,
			error: inputValue.titleError }),
		_react2.default.createElement(_FormInput2.default, { name: 'description',
			updateValue: updateValue,
...
Form.propTypes = {
	...
	inputValue: _propTypes2.default.object,
	addNewResource: _propTypes2.default.func
};
...
var FormInput = function FormInput(_ref) {
	...
	console.log('typeof', typeof error === 'undefined' ? 'undefined' : _typeof(error));
	return _react2.default.createElement(
		'fieldset',
		null,
		_react2.default.createElement(
		...
		_react2.default.createElement(
			'p',
			{ className: error ? 'validation-error' : 'hidden' },
			' Please enter ',
			name,
			' '
		)
...
var _ResourcesItem = __webpack_require__(/*! ./ResourcesItem */ "./src/components/ResourcesItem.js");

var _ResourcesItem2 = _interopRequireDefault(_ResourcesItem);
...
/***/ "./src/components/ResourcesItem.js":
/*!*****************************************!*\
  !*** ./src/components/ResourcesItem.js ***!
  \*****************************************/
/*! no static exports found */
...
var ResourcesItem = function ResourcesItem(_ref) {
	var resourcesItem = _ref.resourcesItem;
	var title = resourcesItem.title,
	    description = resourcesItem.description,
...
ResourcesItem.propTypes = {
	resourcesItem: _propTypes2.default.object
};

exports.default = ResourcesItem;
...
var _Form = __webpack_require__(/*! ../components/Form */ "./src/components/Form.js");
...
var getInputValue = function getInputValue(state) {
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		updateValue: function updateValue(inputValue, name) {
			return dispatch((0, _actions.updateValue)(inputValue, name));
		},
		addNewResource: function addNewResource(inputValue) {
			return dispatch((0, _actions.addNewResource)(inputValue));
		}
	};
};
...
/***/ "./src/containers/ResourcesContainer.js":
/*!**********************************************!*\
  !*** ./src/containers/ResourcesContainer.js ***!
  \**********************************************/
/*! no static exports found */
...
var _Resources = __webpack_require__(/*! ../components/Resources */ "./src/components/Resources.js");
...
var _inputValue = __webpack_require__(/*! ./inputValue */ "./src/reducers/inputValue.js");
...
exports.default = (0, _redux.combineReducers)({
	inputValue: _inputValue2.default
});

/***/ }),

/***/ "./src/reducers/inputValue.js":
/*!************************************!*\
  !*** ./src/reducers/inputValue.js ***!
  \************************************/
/*! no static exports found */
...
function addOrValidate(state) {
	if (state.url && state.title && state.description) {
		return Object.assign({}, state, {
			resources: state.resources.concat({ url: state.url,
				title: state.title,
...
/***/ "./src/styles/components/App.scss":
/*!****************************************!*\
  !*** ./src/styles/components/App.scss ***!
  \****************************************/
/*! no static exports found */
...
var content = __webpack_require__(/*! !../../../node_modules/css-loader!../../../node_modules/sass-loader/lib/loader.js!./App.scss */ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/components/App.scss");
